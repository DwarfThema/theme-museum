...
const DonggiPage: React.FC<ContentsProps> = ({ onMainLoading }) => {
  return (
    <div className="bg-black w-screen h-screen flex justify-center xl:items-center lg:items-end zero:items-end no-drag">
      ...
      {/* 본문 */}
      <div className="z-10 xl:xl:w-10/12 zero:w-11/12 zero:w-11/12 xl:mb-0 lg:mb-[100px] zero:mb-[80px] text-white">
        <div>
